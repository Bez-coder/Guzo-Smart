    ...
    <div className="min-h-screen flex items-center justify-center bg-[var(--color-guzo-yellow-50)] p-4">
      <div className="bg-white max-w-md w-full rounded-3xl shadow-xl p-8 border border-[var(--color-guzo-yellow-100)]">
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-[var(--color-guzo-yellow-800)] font-medium mt-1">Create an account to save routes</p>
        </div>
        ...
        <form onSubmit={handleSignUp} className="space-y-5">
          ...
          <button 
            type="submit" 
            className="w-full bg-[var(--color-guzo-yellow-950)] hover:bg-[var(--color-guzo-yellow-800)] text-[var(--color-guzo-yellow-400)] font-bold py-3.5 rounded-xl transition-colors shadow-md flex justify-center items-center group mt-2"
          >
            Create Account
